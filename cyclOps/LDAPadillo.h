...
namespace cyclOps {
	...
	public:
		...
		static const char* ATTRIBUTE_DISTINGUISHED_NAME;
		static const char* ATTRIBUTE_USER_ACCOUNT_CONTROL;
		static const char* ATTRIBUTE_SAM_ACCOUNT_NAME;
		static const char* ATTRIBUTE_CN;
		static const char* ATTRIBUTE_OPERATING_SYSTEM;
		static const char* ATTRIBUTE_DESCRIPTION;
		static const char* ATTRIBUTE_MEMBER_OF;
		static const char* ATTRIBUTE_MEMBER;
		static const char* ATTRIBUTE_DISPLAY_NAME;
		static const char* ATTRIBUTE_MAIL;
	private:
		...
		void	checkResult(ULONG result, const char* szFunction);
	};
}
#endif